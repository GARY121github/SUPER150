...
Input Format
Enter the values of all the nodes in the binary tree in pre-order format where true suggest the node exists and false
suggests it is NULL
...
class Main {
    ...
    private class BinaryTree {
        ...
        private void siblingNode(Node root) {
            if(root==null){
                return;
            }
